...
Robot.srdfFilename = 'package://romeo_description/srdf/romeo_moveit.srdf'
robot = Robot ('romeo-placard', 'romeo')

# Define classes for the objects {{{4
class Placard (object):
  rootJointType = 'freeflyer'
  urdfFilename = "package://hpp_environments/urdf/placard.urdf"
  srdfFilename = "package://hpp_environments/srdf/placard.srdf"
